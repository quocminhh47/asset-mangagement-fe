                        ...
                        <ModalWrapper showModal={showModal} id='detailUser-wrapper'>
                            ...
                            <ModalContent>
                                ...
                                <DetailContent>
                                        ...
                                        {userName.length >= 20 ? userName.substring(0, 20) + '...' : userName}
                                        {
                                            userName.length >= 20 ?
                                                <div style={{
                                                    ...
                                                    , position: "absolute", width: '15rem', backgroundColor: '#f5f5f5'
                                                    , wordWrap: "break-word", height: 'auto'
                                                    , border: "1px solid #333", paddingLeft: "20px", borderRadius: "10px"
                                                }}>
                                                    {userName}
                                                </div>
                                    ...
                                    <DetailContentItem id="detailUser_birthDate">{DateFormatterService.dateFormat(dob)}</DetailContentItem>
                                    <DetailContentItem id="detailUser_gender">{gender ? 'Male' : 'Female'}</DetailContentItem>
                                    <DetailContentItem id="detailUser_joinedDate">{DateFormatterService.dateFormat(joinedDate)}</DetailContentItem>
                                    <DetailContentItem id="detailUser_type">{StringFormatter.capitalizeFirstLetter(role)}</DetailContentItem>
