                        ...
                        >
                            {
                                roles.length > 0 ?
                                    roles.map((role) => {
                                        return (
                                            <Option value={role.name} selected={role.name==="STAFF"}>{StringFormatter.capitalizeFirstLetter(role.name)}</Option>
                                        );
                                    })
                                    : null
                            }
                                ...
                                >
                                    {
                                        ...
                                        locations.map((location) => {
                                                return (
                                                    <Option value={location.name}>{StringFormatter.capitalizeFirstLetterOfEachWord(location.name)}</Option>
                                                );
                                            })
                                            : null
                                    }
