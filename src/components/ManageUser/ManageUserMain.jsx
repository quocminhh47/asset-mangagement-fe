...
import {  CloseOutlined,FilterAltOutlined, SearchOutlined, ArrowDropDownOutlined, ArrowDropUpOutlined, South } from "@mui/icons-material";
...
import { Cancel } from 'react-bootstrap-icons';
...
const ManageUserMain = () => {
    ...
    if (savedUser) { console.log(savedUser.localtionCode); }
                                        ...
                                        <Tbody id="userTableBody">
                                            {
                                                savedUser ?
                                                    (<Tr id={savedUser.staffCode} key={savedUser.staffCode}>
                                                        <Td onClick={() => openModal({ type: "detailUser", user: savedUser })} >{savedUser.staffCode}</Td>
                                                        <Td onClick={() => openModal({ type: "detailUser", user: savedUser })} >{savedUser.firstName + ' ' + savedUser.lastName}</Td>
                                                        <Td onClick={() => openModal({ type: "detailUser", user: savedUser })}>{savedUser.username}</Td>
                                                        <Td onClick={() => openModal({ type: "detailUser", user: savedUser })} >
                                                        ...
                                                        <Td style={{ border: "none" }}>
                                                            <Button
                                                                ...
                                                                onClick={() => { navigate("/edit-user", { state: { staffCode: savedUser.staffCode, firstName: savedUser.firstName, lastName: savedUser.lastName, birthDate: savedUser.birthDate, joinedDate: savedUser.joinedDate, gender: savedUser.gender, roleName: savedUser.roleName } }) }}
                                                            >
                                                                <FontAwesomeIcon style={{ fontSize: "1.2rem", marginLeft: "25px", color: "#707070" }} icon={faPencilAlt} />
                                                            </Button>
                                                        </Td>
                                                        <Td style={{ border: "none" }}>
                                                            <Button id={savedUser.staffCode + "-del"} onClick={() => handleClickDisableUser(savedUser)}>
                                                                <CloseOutlined style={{ border: "2px solid #de6a79", borderRadius: "50%", color: "#de6a79", marginLeft: "25px" }} />
                                                            </Button>
                                                        </Td>
                                                    </Tr>) : ''
                                            }
                                                        ...
                                                        (savedUser.staffCode != user.staffCode ?
                                                            (
                                                                <Tr id={user.staffCode} key={user.staffCode}>
                                                                    ...
                                                                    <Td style={{ border: "none" }}>
                                                                        <Button id={user.staffCode + "-del"} onClick={() => handleClickDisableUser(user)}>
                                                                            <CloseOutlined style={{ border: "2px solid #de6a79", borderRadius: "50%", color: "#de6a79", marginLeft: "25px" }} />
                                                                        </Button>
                                                                    </Td>
                                                                </Tr>
