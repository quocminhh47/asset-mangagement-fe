    ...
    function handleDeleteAssignment() {
        assignmentService.deleteAssignment(assignment.assignedTo,assignment.assetCode,assignment.assignedDate)
            .then(res =>{
                ...
                if (savedAssignment) {localStorage.removeItem('savedAssignment') }
                // Toast
                    ...
                    <Background ref={modalRef} onClick={closeModal}>
                        <ModalWrapper showModal={showModal} >
                            ...
                            <ModalContent>
                                ...
                                <DetailContent>
                                    <DetailContentItem id="detailUser_assetCode">{assignment ? assignment.assetCode : ""}</DetailContentItem>
                                    ...
                                    <DetailContentItem id="detailUser_assignedTo">{assignment ? assignment.assignedTo : ""}</DetailContentItem>
                                    <DetailContentItem id="detailUser_assignedBy">{assignment ? assignment.assignedBy : ""}</DetailContentItem>
                                    <DetailContentItem id="detailUser_assignedDate">{assignment ? assignment.assignedDate : ""}</DetailContentItem>
                                    <DetailContentItem id="detailUser_state">{assignment ? assignment.state : ""}</DetailContentItem>
                    ...
                    <Background ref={modalRef} onClick={closeModal}>
                        <ModalWrapperDateChange showModal={showModal} >
                            ...
                            <ModalContentDateChange>
                                    ...
                                    <DetailContentItem id="detail-assigned-date-changed">Assigned Date has been changed due to the change of user's joinedDate or asset's  installedDate</DetailContentItem>
