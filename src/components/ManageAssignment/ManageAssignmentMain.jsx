    ...
    const handleChooseDate = (e) => {
        ...
        AssignmentService.filterAssignment(states, searching, choosenDate, 0)
            ...
            .catch(err => {
                ...
                if (validation) { setErrMess(validation.message.replaceAll('.', ' ')) }
            })
    }
    //===========searching============
                                        ...
                                        id={savedAssignment.assetCode + "-" + savedAssignment.assignedTo + "-" + savedAssignment.assignedDate}
                                            ...
                                            <Td style={{ border: 'none' }}>
                                                <Button id={savedAssignment.assetCode + '-edit'}
                                                    ...
                                                    onClick={(e) => {
                                                        ...
                                                        ,{state: {assetCode: savedAssignment.assetCode, assetName:savedAssignment.assetName
                                                            , assignedTo: savedAssignment.assignedTo,assignedDate:savedAssignment.assignedDate
                                                            , note:savedAssignment.note, firstName: savedAssignment.assignedToFirstname
                                                            , lastName: savedAssignment.assignedToLastname
                                                            , staffCode: savedAssignment.assignedToStaffCode}})
                                                    }}>
                                                    <FontAwesomeIcon
                                                        style={{ fontSize: '1.2rem', marginLeft: '15px', color:savedAssignment.state === "Waiting for acceptance"?'#707070' :'#b6b6b6' }}
                                                        icon={faPencilAlt}
                                                    />
                                                </Button>
                                            </Td>
                                            <Td style={{ border: 'none' }}>
                                                <Button id={savedAssignment.assetCode + '-reject'}
                                                        ...
                                                        onClick={() => {
                                                            openModal({type:"confirmDeleteAssignment",assignment:{
                                                                    assetCode: savedAssignment.assetCode,
                                                                    assignedTo: savedAssignment.assignedTo,
                                                ...
                                                >
                                                    <CloseOutlined
                                                        style={{ border: savedAssignment.state === "Accepted" ? '2px solid #efbec4' : '2px solid #de6a79',
                                                            borderRadius: '50%',
                                            ...
                                            <Td style={{ border: 'none' }}>
                                                <Button id={savedAssignment.assetCode + '-request'}
                                                    onClick={(e) => {
                                                        e.stopPropagation();
                                                        openModal({type:"returningRequestAdmin", assignment: savedAssignment});
                                                    }}
                                                    attr
                                                    ...
                                                    >
                                                    <ReplayOutlined style={{color: savedAssignment.requestReturningId !== null || savedAssignment.state==='Waiting for acceptance' || savedAssignment.state==='Declined' ? '#bcbcbc' : ''}}/>
                                                </Button>
                                            </Td>
                                        </Tr>
                                    ) : ''
                                                     ...
                                                     id={ass.assetCode + "-" + ass.assignedTo + "-" + ass.assignedDate}
                                                        ...
                                                        <Td style={{ border: 'none' }}>
                                                            <Button id={ass.assetCode + '-edit'}
                                                                ...
                                                                onClick={(e) => {
                                                                    navigate("/edit-assignment"
                                                                    ,{state: {assetCode: ass.assetCode, assetName:ass.assetName
                                                                        , assignedTo: ass.assignedTo,assignedDate:ass.assignedDate, note:ass.note
                                                                        , firstName: ass.assignedToFirstname
                                                                        , lastName: ass.assignedToLastname
                                                                        , staffCode: ass.assignedToStaffCode}})
                                                                }}>
                                                                <FontAwesomeIcon
                                                                    style={{ fontSize: '1.2rem', marginLeft: '15px', color:ass.state === "Waiting for acceptance"?'#707070' :'#b6b6b6' }}
                                                                    icon={faPencilAlt}
                                                                />
                                                            </Button>
                                                        </Td>
                                                        <Td style={{ border: 'none' }}>
                                                            ...
                                                            >
                                                                <CloseOutlined
                                                                    style={{ border: ass.state === "Accepted" ? '2px solid #efbec4' : '2px solid #de6a79',
                                                                        borderRadius: '50%',
                                                        ...
                                                        <Td style={{ border: 'none' }}>
                                                            <Button id={ass.assetCode + '-request'}
                                                                onClick={(e) => {
                                                                    e.stopPropagation();
                                                                    openModal({type:"returningRequestAdmin", assignment: ass});
                                                                }}
                                                                attr
                                                                disabled = {ass.requestReturningId !== null || ass.state==='Waiting for acceptance' || ass.state==='Declined'? true:false}
                                                                >
                                                                <ReplayOutlined style={{color: ass.requestReturningId !== null || ass.state==='Waiting for acceptance' || ass.state==='Declined'? '#bcbcbc' : '#5b6ee3'}}/>
                                                            </Button>
                                                        </Td>
                                                    </Tr>
                                                ) : '')
